...
// Get all products in the Football category 
$sql = "SELECT * FROM products WHERE LOWER(category) = 'football'";
...
<body>
    ...
    <div class="jersey-container">
        <?php if (mysqli_num_rows($result) > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p style="background-color: rgba(0,0,0,0.6); display: inline-block; padding: 15px; border-radius: 10px;">No football jerseys found.</p>
        <?php endif; ?>
    </div>
