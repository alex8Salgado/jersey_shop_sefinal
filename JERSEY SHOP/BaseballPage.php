...
// Get all products in the Baseball category 
$sql = "SELECT * FROM products WHERE LOWER(category) = 'baseball'";
...
<html>
<head>
    <title>Baseball Jerseys</title>
    <style>
        body {
            margin: 0;
            padding: 0;
            background: url("images/baseball_field.jpg") no-repeat center center fixed;
...
<body>
    ...
    <div class="jersey-container">
        <?php if (mysqli_num_rows($result) > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p style="background-color: rgba(0,0,0,0.6); display: inline-block; padding: 15px; border-radius: 10px;">
                No baseball jerseys found.
            </p>
        <?php endif; ?>
    </div>
