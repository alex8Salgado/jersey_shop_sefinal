...
// Get all products in the Basketball category 
$sql = "SELECT * FROM products WHERE LOWER(category) = 'basketball'";
...
<html>
<head>
    <title>Basketball Jerseys</title>
    <style>
        body {
            margin: 0;
            padding: 0;
            background: url("images/basketball_court.jpg") no-repeat center center fixed;
